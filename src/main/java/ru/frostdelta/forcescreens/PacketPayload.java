...
public class PacketPayload extends C17PacketCustomPayload {
    ...
    public PacketPayload(String p_i45248_1_, ByteBuf p_i45248_2_)
    {
        this(p_i45248_1_, p_i45248_2_.array());
    }


    public PacketPayload(String p_i45249_1_, byte[] p_i45249_2_)
    {
