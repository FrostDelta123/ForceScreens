...
public enum Action {
    SCREENSHOT("Screenshot"), SCREENSHOTS("Screenshots"), UNKNOWN("Unknown action"), PROCESS("Dump"), DUMPS("GetDumps"), HWID("HWID"), BAN("BAN"), CLASSES("CLASSES"), VERIFYCLASS("VerifyClass");
